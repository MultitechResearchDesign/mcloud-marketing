...
const devices = [
  ...
  {
    name: 'Conduit Programmable Gateway',
    sku: 'MTCDT-L4N1-247A-915.R3-US',
  ...
  {
    name: 'rCell 300 Series',
    sku: 'MTR3-L4G2D-AC00QA-EWM',
    desc: 'Compact cellular router with eSIM for flexible carrier management.',
    tags: ['LTE Cat 4', 'eSIM', 'Wi-Fi'],
    price: '$699',
    badge: 'NEW',
  },
  {
    name: 'Palantiri 64-Channel',
    sku: 'PALANTIRI-64CH-US915',
  ...
  },
  {
    ...
    sku: 'MTR-LEW1-B07-US',
    desc: 'Compact cellular router for small IoT deployments.',
    tags: ['Cellular', 'Wi-Fi', 'Bluetooth'],
    price: '$449',
    badge: null,
  },
  {
